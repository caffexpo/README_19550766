        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="eventform" action="<?php echo base_url();?>index.php/complains/save_complain_category" method="post">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="comp_cat" name="comp_cat" placeholder="" required="required">
                      </div>
                    </div>
            ...
            <ul>
              ...
              if($complaincats){
               ...
               ?>
               <li><?php echo $cc->complain_category;?></li>
               <?php
             }
            }
              ?>
