  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?php echo base_url();?>assets/dist/img/" alt="" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo base_url()?>index.php/employee/view_profile/<?php echo $this->session->userdata('emp_id');?>" class="d-block"><?php echo $this->session->userdata('logged_user');?></a>
        </div>
      </div>
