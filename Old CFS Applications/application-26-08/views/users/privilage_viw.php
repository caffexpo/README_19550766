            ...
            <div class="card card-primary">
              ...
              <table class="table">
                ...
                if($usertypes){
                  ...
                  ?>
                <tr>
                  <td><?php echo $ut->user_type_id;?></td>
                  <td><?php echo $ut->user_type;?></td>
                  <td><a href="<?php echo base_url();?>index.php/users/setup_privilages/<?php echo $ut->user_type_id;?>" class="btn btn-success btn-sm">Set Privilages</a></td>
                </tr>
                  <?php
                }
                }
