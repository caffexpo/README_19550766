        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?php echo base_url();?>index.php/organization/add_organization" method="post">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="orgname" name="orgname" placeholder="Enter Organization Name" required="required">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="exampleInputPassword1">Code (type 3 charater)</label>
                        <input type="text" class="form-control" id="shortcode" name="shortcode" placeholder=" ex : NBS" required="required" maxlength="3">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="orgaddress" name="orgaddress" placeholder="Enter Organization Address">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputPassword1">Organization Contact</label>
                        <input type="text" class="form-control" id="orgcontact" name="orgcontact" placeholder="Organization Contact">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="orgemail" name="orgemail" placeholder="Organization E-mail" required="required">
                      </div>
                    </div>
