              ...
              <form role="form" action="<?php echo base_url();?>index.php/beneficiari/add_beneficiari" method="post" id="form_add_benificiaryss">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="bname" name="bname" placeholder=""  required="required">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="baddress" name="baddress" placeholder=""  required="required">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="bdob" name="bdob" placeholder="" required="required">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputPassword1">Contact No</label>
                        <input type="number" class="form-control" id="dcontact" name="dcontact" placeholder="" required="required">
                      </div>
                    </div>
                  </div>
                 ...
                 <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputEmail1">If you are under 18 Please add your parent NIC</label>
                        <input type="text" class="form-control" id="nic" name="nic" placeholder="" required="required">
                      </div>
                    </div>
