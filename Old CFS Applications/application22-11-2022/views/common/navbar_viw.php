       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?php echo base_url();?>index.php/beneficiari/appr_disapprove_benificiary" class="dropdown-item">
            <i class="fa-thumbs-o-up mr-2"></i><?php echo $notificationdata['pending_benificiry'];?>  Pending Benificiaries
          ...
          <!--<a href="<?php echo base_url();?>index.php/employee/approve_roster" class="dropdown-item">
            <i class="fa-thumbs-o-up mr-2"></i> 0 Roster Approvals
            <span class="float-right text-muted text-sm"></span>
          </a>-->
