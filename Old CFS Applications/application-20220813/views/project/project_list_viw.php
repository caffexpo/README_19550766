                ...
                <?php
                 ...
                 <tr>
                  ...
                  <td><?php 
                    ...
                    ?></td>
                  <td><a href="<?php echo base_url();?>index.php/project/approve_disapprove_project/<?php echo $projlist->proj_id;?>/1" class="btn btn-success btn-sm">Edit</a> 
                    <?php
                    if($proj_stts!=3){
                     
                    ?> 
                    &nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/project/approve_disapprove_project/<?php echo $projlist->proj_id;?>/2" class="btn btn-info btn-sm">Finish</a>&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/event/list_event/<?php echo $projlist->proj_id;?>" class="btn btn-warning btn-sm">View Events</a>
                    <?php
                     }
                    ?> 
                  </td>
