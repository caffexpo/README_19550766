                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ednrname" name="ednrname" value="<?php echo $donordetails->donor;?>">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ednrcontact" name="ednrcontact" value="<?php echo $donordetails->d_contact;?>">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputPassword1">E-mail</label>
                        <input type="text" class="form-control" id="ednremail" name="ednremail" value="<?php echo $donordetails->d_mail;?>">
                      </div>
                    </div>
                  </div>
