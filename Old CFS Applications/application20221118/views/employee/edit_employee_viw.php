                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="empname" name="empname" value="<?php echo $empdetails->emp_name;?>">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="empcontact" name="empcontact" value="<?php echo $empdetails->emp_contact;?>">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputPassword1">E-mail</label>
                        <input type="text" class="form-control" id="empemail" name="empemail" value="<?php echo $empdetails->emp_mail;?>">
                      </div>
                    </div>
                  </div>
