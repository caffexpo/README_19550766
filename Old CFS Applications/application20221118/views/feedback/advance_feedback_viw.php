            ...
            <div class="card card-primary">
              ...
              <table class="table">
                ...
                <tr>
                  ...
                  <td><?php echo $elst['verygood'];?>/<?php echo $elst['totalfeedbacks'];?>
                    ...
                    <div class="progress progress-sm">
                        <div class="progress-bar bg-success" style="width:<?php
                          if($elst['verygood']==0){
                            ...
                            $pres = ($elst['verygood']/$elst['totalfeedbacks'])*100;
                            echo $pres;
                          }
                        ?>%">
                        </div>
                  ...
                  <td><?php echo $elst['good'];?>/<?php echo $elst['totalfeedbacks'];?>
                    <div class="progress-group">
                    <div class="progress progress-sm">
                        <div class="progress-bar bg-primary" style="width:<?php
                          if($elst['good']==0){
                            ...
                            $pres = ($elst['good']/$elst['totalfeedbacks'])*100;
                            echo $pres;
                          }
                        ?>%">
                        </div>
                  ...
                  <td><?php echo $elst['poor'];?>/<?php echo $elst['totalfeedbacks'];?>
                    <div class="progress-group">
                    <div class="progress progress-sm">
                        <div class="progress-bar bg-warning" style="width:<?php
                          if($elst['poor']==0){
                            ...
                            $pres = ($elst['poor']/$elst['totalfeedbacks'])*100;
                            echo $pres;
                          }
                        ?>%">
                        </div>
                  ...
                  <td><?php echo $elst['toobad'];?>/<?php echo $elst['totalfeedbacks'];?>
                    <div class="progress-group">
                    <div class="progress progress-sm">
                        <div class="progress-bar bg-danger" style="width:<?php
                          if($elst['toobad']==0){
                            ...
                            $pres = ($elst['toobad']/$elst['totalfeedbacks'])*100;
                            echo $pres;
                          }
                        ?>%">
                        </div>
