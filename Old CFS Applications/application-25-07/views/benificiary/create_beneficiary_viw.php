        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?php echo base_url();?>index.php/beneficiari/add_beneficiari" method="post" id="form_add_benificiary">
                <div class="card-body">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select class="form-control" id="gndiv" name="gndiv" required="required">
                          ...
                          ?>
                          <option value="<?php echo $gnd->gn_division;?>"><?php echo $gnd->gn_division;?></option>
                          <?php
                           }
                          }
                          ?>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="uname" name="uname" placeholder="" required="required">
                        <div id="unexist"></div>
                      </div>
                    </div>
                    <div class="col-md-6">
