...
class Complains extends CI_Controller {
  ...
  // gn division change benificary select controller..
  function get_gndiv_related_beneficiries(){
    $gndiv = $this->input->post('gndiv');
    $beni = $this->common_model->get_related_beneficiaries($gndiv);
    echo json_encode($beni);
  }
