...
class Project extends CI_Controller {
  ...
  public function create_project(){
    ...
    $data['notificationdata'] = $this->get_notifications();
     $data['qulaity']  = $this->common_model->get_qulaity();
  ...
  function add_project(){
    ...
    $donorid = $this->input->post('donorid');
     $quality = $this->input->post('projstatus1');
    ...
    $projarr['donor_id'] = $donorid;
     $projarr['project_status'] = $project_sts;
  ...
  function list_project_approve_disaprove(){
    ...
    $data['titlename'] = "Approve/Reject Project List";
  ...
  function list_project(){
    ...
    $data['notificationdata'] = $this->get_notifications();
  $data['project_sts'] = $this->common_model->get_all_project_by_stats(0);
