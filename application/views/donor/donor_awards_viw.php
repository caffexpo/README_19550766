        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <table class="table table-striped projects" id="example1">
                ...
                <?php
                 ...
                 <tr style="font-weight: bold;">
                  <td><?php echo $da->donor;?></td>
                  <td><?php echo $da->donor_stage;?></td>
                  <td><?php echo $da->year_donation;?></td>
              ...
              <a class="btn btn-sm btn-success" href="<?php echo base_url();?>index.php/donor/send_award_mail">Send Mail</a>
