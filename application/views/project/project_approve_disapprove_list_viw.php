              ...
              <table class="table">
                ...
                <?php
                 ...
                 <tr>
                  ...
                  <td><a href="<?php echo base_url();?>index.php/project/approve_disapprove_project/<?php echo $projlist->proj_id;?>/1" class="btn btn-success btn-sm">Approve</a> &nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/project/approve_disapprove_project/<?php echo $projlist->proj_id;?>/3" class="btn btn-danger btn-sm">Reject</a></td>
                </tr>
                 <?php
                   }
                 }
