...
body,html
{
  ...
  .db-view {
background-image: url("<?php echo base_url('assets/dist/img/bkimg.jpg');?>");
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="<?php echo base_url();?>index.php/organization/list_organizations" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="<?php echo base_url();?>index.php/employee/list_employee" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="<?php echo base_url();?>index.php/project/list_project" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="<?php echo base_url();?>index.php/event/list_event" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
            ...
            <div class="card">
              <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                  <h3 class="card-title">Donation Comparition</h3>
...
<script type="text/javascript">
  ...
  var salesChart  = new Chart($salesChart, {
    type   : 'bar',
    data   : {
      labels  : [<?php echo $yr4;?>, <?php echo $yr3;?>,<?php echo $yr2;?>, <?php echo $yr1;?>, <?php echo $yr;?>],
      datasets: [
        {
