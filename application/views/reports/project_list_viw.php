            ...
            <div class="row">
              <div class="col-md-4">
               ...
               <!--<select class="form-control" name="stts" required="required">
                  ...
                  <option value="1">Active and Ongoing</option>
                ...
                <!--<select class="form-control" name="stts" id="stts" required="required">
                          <option value="">Select Desigation</option>
                          <?php
                          if($projectstatus){
                          foreach($projectstatus as $stts){
                          ?>
                          <option value="<?php echo $stts->project_status;?>" <?php echo set_select('stts', $stts->project_status); ?>><?php echo $stts->projectstatus;?></option>
                          <?php
                            }
                          }
                          ?>
